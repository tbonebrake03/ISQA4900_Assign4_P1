...
var UserDataWriter = class extends AbstractUserDataWriter {
  ...
  convertReference(name2) {
    ...
    return DocumentReference2.forKey(key, this.firestore, null);
  }
};
...
var DocumentReference2 = class {
  ...
  static forPath(path, firestore, converter) {
    ...
    return new DocumentReference2(firestore, new DocumentReference(firestore._delegate, converter, new DocumentKey(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference2(firestore, new DocumentReference(firestore._delegate, converter, key));
  }
  get id() {
...
var Query2 = class {
  ...
  startAt(...args) {
    try {
      return new Query2(this.firestore, query(this._delegate, startAt(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query2(this.firestore, query(this._delegate, startAfter(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new Query2(this.firestore, query(this._delegate, endBefore(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new Query2(this.firestore, query(this._delegate, endAt(...args)));
    } catch (e) {
...
var FieldPath2 = class {
  ...
  static documentId() {
    return new FieldPath2(FieldPath$1.keyField().canonicalString());
  }
  isEqual(other) {
    other = getModularInstance(other);
